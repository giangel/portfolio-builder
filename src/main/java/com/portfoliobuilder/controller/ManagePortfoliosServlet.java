...
@WebServlet("/admin/portfolios")
public class ManagePortfoliosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            request.setAttribute("portfolios", adminService.getAllPortfolios());
            request.getRequestDispatcher("/views/admin/portfolios.jsp").forward(request, response);
